...
/**
 * Interceptor that triggers method-level role evaluation for methods
 * annotated with security annotations when the class itself does not
 * carry a class-level security annotation.
 */
@Interceptor
@RoleMethodAdapterInterceptorBinding
@Priority(Interceptor.Priority.LIBRARY_BEFORE)
public class RoleMethodAdapterInterceptor implements Serializable
{
