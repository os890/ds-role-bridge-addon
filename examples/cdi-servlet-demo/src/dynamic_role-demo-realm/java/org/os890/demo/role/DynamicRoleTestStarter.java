...
/**
 * Bootstraps a Meecrowave container with a dynamic test realm for testing
 * the CDI-Servlet role bridge demo.
 */
public class DynamicRoleTestStarter
{
    /**
     * Starts the Meecrowave container and awaits shutdown.
     *
