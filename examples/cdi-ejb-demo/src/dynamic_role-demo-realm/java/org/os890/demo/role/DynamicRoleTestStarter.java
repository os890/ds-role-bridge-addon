...
/**
 * Bootstraps a WildFly Swarm container with an in-memory security realm
 * for testing the CDI-EJB role bridge demo.
 */
public class DynamicRoleTestStarter {
    /**
     * Starts the Swarm container and deploys the CDI-EJB demo WAR.
     *
     * @param args command-line arguments
     * @throws Exception if container startup or deployment fails
     */
